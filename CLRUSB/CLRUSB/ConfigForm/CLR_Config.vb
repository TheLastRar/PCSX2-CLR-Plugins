...
Namespace Config
    ...
    Class CLR_Config
        Inherits CLR_PSE_Config
        Private SettingsFile As CLR_FreezeData = Nothing
        ...
        Public Overrides Sub Configure()
            ...
            SetLoggingState()
            DirectCast(Base, CLR_USB).CreateDevices()
        ...
        Public Overrides Sub LoadConfig()
            ...
            SettingsFile = New CLR_FreezeData
            ...
            Catch ex As Exception
                SettingsFile = New CLR_FreezeData
                Base.PluginLog.LogWriteLine("Failed to open " & IniPath)
                SaveConfig()
            End Try
            ...
            DirectCast(Base, CLR_USB).CreateDevices()
        End Sub
        Protected Overrides Sub SaveConfig()
            Dim IniPath As String = IniFolderPath
            If IniFolderPath.EndsWith(IO.Path.DirectorySeparatorChar) Then
                IniPath += "USB_CLR.ini"
            Else
        ...
        Private Sub SetLoggingState()
            Base.PluginLog.SetWriteToFile(EnableLog)
        End Sub
