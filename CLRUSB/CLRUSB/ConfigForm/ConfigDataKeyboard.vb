...
Namespace Config
    Class ConfigDataKeyboard
        ...
        Public Sub SaveConfig(Port As Integer, Data As CLR_FreezeData) Implements IConfigData.SaveConfig
            SaveLoad(Port, Data, True)
        End Sub

        Public Sub LoadConfig(Port As Integer, Data As CLR_FreezeData) Implements IConfigData.LoadConfig
            SaveLoad(Port, Data, False)
        End Sub

        Private Sub SaveLoad(Port As Integer, Data As CLR_FreezeData, Saving As Boolean)
            Try
